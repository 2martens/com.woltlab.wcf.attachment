						...
						{if $attachment->isImage}
							<li class="attachmentThumbnail">
								{if $attachment->thumbnailType}
									<a href="{link controller='Attachment' object=$attachment}{/link}"><img src="{link controller='Attachment' object=$attachment}thumbnail=1{/link}" alt="" style="{*width: 144px; height: 144px; border-radius: 10px; box-shadow: 2px 2px 7px rgba(0, 0, 0, .5);*}" /></a>
								{else}
